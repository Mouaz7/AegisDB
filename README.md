...
- [ADR 0001: Architecture and Tech Stack Selection](docs/adr/0001-architecture-and-tech-stack.md)
- [ADR 0002: Java-First Module Structure and Strict Decoupling](docs/adr/0002-java-first-module-structure.md)
- [ADR 0003: Raft Consensus Engine State Machine & Event Loop](docs/adr/0003-raft-consensus-engine.md)
- [ADR 0004: Segmented Write-Ahead Log Framing and Checksumming](docs/adr/0004-segmented-wal-and-persistence.md)
- [ADR 0005: Chunked Snapshot Streaming and Log Compaction](docs/adr/0005-snapshots-and-compaction.md)
- [ADR 0006: Multi-Version Concurrency Control (MVCC) & GC](docs/adr/0006-mvcc-and-snapshot-isolation.md)
- [ADR 0007: Single-Shard Transaction Execution and ACID Guarantees](docs/adr/0007-single-shard-transactions.md)
- [ADR 0008: Dynamic Consistent Hashing and Query Routing](docs/adr/0008-sharding-and-query-routing.md)
- [ADR 0009: Two-Phase Commit Distributed Transactions](docs/adr/0009-cross-shard-distributed-transactions.md)
- [ADR 0010: Chaos Engineering and Management Security Hardening](docs/adr/0010-chaos-and-security-hardening.md)
