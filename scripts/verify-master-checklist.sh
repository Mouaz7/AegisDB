...
CHECKLIST=(
    ...
    "Leader failure triggers recovery|ReplicatedKeyValueStoreTest, Sprint10Demo|PASS"
    ...
    "Local transactions are atomic|SingleShardTransactionMilestoneM3Test, TransactionManagerTest|PASS"
    "Shards route deterministically|HashPartitionerTest, ShardRouterTest, MultiShardClusterTest|PASS"
    "Cross-shard 2PC transactions recover correctly|CrossShardTransactionMilestoneM4Test, DistributedTxCoordinatorTest|PASS"
    "Retries and duplicate messages are idempotent|FaultyTransportTest, DefaultAegisDbClientTest|PASS"
    "Chaos tests include partition/delay/drop/kill scenarios|ChaosScenariosIntegrationTest, Sprint10Demo|PASS"
    ...
    "OpenTelemetry metrics/traces are available|AegisMetricsTest, AegisTracerTest, Sprint11Demo|PASS"
